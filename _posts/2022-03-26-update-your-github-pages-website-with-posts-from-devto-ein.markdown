...
> <div class=card><div class=container><h4><b><a href="https://dev.to/brunodrugowick/update-your-github-pages-website-with-posts-from-devto-ein">You'll have a better experience reading in DEV...</a></b></h4><i><p>However, if you want to know more about the project to mirror my posts from DEV here (and why), go ahead and <a href="https://dev.to/brunodrugowick/update-your-github-pages-website-with-posts-from-devto-ein">read more</a>.</p><p>You can continue to read here too, it's up to you...</p></i></div></div>
<h2>
...
on:
 schedule:
 - cron: '30 23 404.html about.markdown assets _config.yml _data Gemfile Gemfile.lock img index.markdown last_updated_date _posts README.md scripts _site 404.html about.markdown assets _config.yml _data Gemfile Gemfile.lock img index.markdown last_updated_date _posts README.md scripts _site *'
 workflow_dispatch:
