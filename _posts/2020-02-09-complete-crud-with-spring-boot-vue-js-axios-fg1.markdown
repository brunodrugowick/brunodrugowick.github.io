...
> <div class=card><div class=container><h4><b><a href="https://dev.to/brunodrugowick/complete-crud-with-spring-boot-vue-js-axios-fg1">You'll have a better experience reading in DEV...</a></b></h4><i><p>However, if you want to know more about the project to mirror my posts from DEV here (and why), go ahead and <a href="https://dev.to/brunodrugowick/complete-crud-with-spring-boot-vue-js-axios-fg1">read more</a>.</p><p>You can continue to read here too, it's up to you...</p></i></div></div>
